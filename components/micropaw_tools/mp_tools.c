...
static const tool_t s_tools[] = {
    {"memory_save", "{\"type\":\"function\",\"name\":\"memory_save\",\"description\":\"Save one durable fact of up to 1023 bytes for later conversations. Call memory_list first in the same turn. Save separate facts with separate calls.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{\"note\":{\"type\":\"string\"}},\"required\":[\"note\"],\"additionalProperties\":false}}", memory_save},
    ...
    {"email_modify", "{\"type\":\"function\",\"name\":\"email_modify\",\"description\":\"Change a Gmail message state after reading current matching mail with email_search or email_get in the same turn.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"action\":{\"type\":\"string\",\"enum\":[\"mark_read\",\"mark_unread\",\"archive\",\"move_to_inbox\",\"star\",\"unstar\",\"mark_spam\",\"not_spam\"]}},\"required\":[\"id\",\"action\"],\"additionalProperties\":false}}", email_modify},
    {"email_trash", "{\"type\":\"function\",\"name\":\"email_trash\",\"description\":\"Move one Gmail message to trash after reading current matching mail in the same turn.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"}},\"required\":[\"id\"],\"additionalProperties\":false}}", email_trash},
    {"email_untrash", "{\"type\":\"function\",\"name\":\"email_untrash\",\"description\":\"Restore one Gmail message from trash after reading current matching mail in the same turn.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"}},\"required\":[\"id\"],\"additionalProperties\":false}}", email_untrash},
#endif
#if CONFIG_MICROPAW_CALENDAR
    {"calendar_create", "{\"type\":\"function\",\"name\":\"calendar_create\",\"description\":\"Create a Google Calendar event after calling calendar_list in the same turn. Call time_now before resolving relative or partial dates. Never guess a missing month or year.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{\"summary\":{\"type\":\"string\"},\"start_rfc3339\":{\"type\":\"string\"},\"end_rfc3339\":{\"type\":\"string\"}},\"required\":[\"summary\",\"start_rfc3339\",\"end_rfc3339\"],\"additionalProperties\":false}}", calendar_create},
