...
static const tool_t s_tools[] = {
    ...
    {"schedule_missed_clear", "{\"type\":\"function\",\"name\":\"schedule_missed_clear\",\"description\":\"Clear delivered missed-reminder history after calling schedule_missed_list and waiting for its result. Pending deliveries remain.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{},\"required\":[],\"additionalProperties\":false}}", schedule_missed_clear},
    ...
    {"web_search", "{\"type\":\"function\",\"name\":\"web_search\",\"description\":\"Search through Brave or an official specialised source. Returned page URLs may be passed to web_fetch.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{\"query\":{\"type\":\"string\",\"minLength\":1,\"maxLength\":400},\"provider\":{\"type\":\"string\",\"enum\":[\"brave\"" MP_PROVIDER_WIKIPEDIA MP_PROVIDER_ARXIV "]}},\"required\":[\"query\",\"provider\"],\"additionalProperties\":false}}", web_search},
    ...
    {"email_trash", "{\"type\":\"function\",\"name\":\"email_trash\",\"description\":\"Move one Gmail message to trash after reading current matching mail and waiting for its result.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"}},\"required\":[\"id\"],\"additionalProperties\":false}}", email_trash},
    {"email_untrash", "{\"type\":\"function\",\"name\":\"email_untrash\",\"description\":\"Restore one Gmail message from trash after reading current matching mail and waiting for its result.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"}},\"required\":[\"id\"],\"additionalProperties\":false}}", email_untrash},
#endif
#if CONFIG_MICROPAW_CALENDAR
    {"calendar_create", "{\"type\":\"function\",\"name\":\"calendar_create\",\"description\":\"Create a Google Calendar event after calling calendar_list and time_now. Wait for both results before resolving dates or creating the event. Never guess a missing month or year.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{\"summary\":{\"type\":\"string\"},\"start_rfc3339\":{\"type\":\"string\"},\"end_rfc3339\":{\"type\":\"string\"}},\"required\":[\"summary\",\"start_rfc3339\",\"end_rfc3339\"],\"additionalProperties\":false}}", calendar_create},
    ...
    {"calendar_update", "{\"type\":\"function\",\"name\":\"calendar_update\",\"description\":\"Update supplied fields on a Google Calendar event after reading it with calendar_list or calendar_get and calling time_now. Wait for both results before resolving dates or updating the event. Empty fields are left unchanged.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"summary\":{\"type\":\"string\"},\"start_rfc3339\":{\"type\":\"string\"},\"end_rfc3339\":{\"type\":\"string\"}},\"required\":[\"id\",\"summary\",\"start_rfc3339\",\"end_rfc3339\"],\"additionalProperties\":false}}", calendar_update},
    {"calendar_delete", "{\"type\":\"function\",\"name\":\"calendar_delete\",\"description\":\"Delete one Google Calendar event after reading it with calendar_list or calendar_get and waiting for its result. send_updates controls attendee notifications.\",\"strict\":true,\"parameters\":{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"send_updates\":{\"type\":\"string\",\"enum\":[\"none\",\"all\",\"externalOnly\"]}},\"required\":[\"id\",\"send_updates\"],\"additionalProperties\":false}}", calendar_delete},
#endif
};
